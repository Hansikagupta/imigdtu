		  ...
		  <div>
		    ...
		    <div class="text-center">
		        <img src="../assets/img/logo.png" alt="Metis Logo" style="width: 100px;">
		                <h5>Indira Gandhi Delhi Technical University for Women</h5>
		        <h3>imigdtu</h3>
		    ...
		    <div class="text-center">
		      ...
		      <div class="container">
		        ...
		        <div class="navbar-header">
		          <img src="../assets/img/logo.png" alt="imigdtu" style="width: 40px; margin-top: 6px; ">
		          <a class="navbar-brand" href="#">imigdtu</a>
		        </div>
