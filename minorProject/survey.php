                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    <div class="box" >
                                     ...
                                     <?php
$sql1 = mysqli_query($con,"SELECT * FROM `survey`");
$title = mysqli_query($con,"SELECT survey_name FROM `survey`");
$idList = mysqli_query($con,"SELECT survey_ID FROM `survey`");

$j = 1;

while ($titleVal = mysqli_fetch_array($title)){
// $titleArr = mysqli_fetch_array($title);
// $titleArr2 = mysqli_fetch_array($title);

// $sid = $title[1];
$idVal = mysqli_fetch_array($idList) ;
$sid = $idVal[0];
